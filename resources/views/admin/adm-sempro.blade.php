    ...
    <div class="card">
        ...
        <div class="card-body">
          <table class="table table-bordered table-striped table-hover">
            ...
            <tbody>
                @foreach ($data_sempro as $key => $data )
                <tr>
                    <td>{{ $key+1 }}</td>
                    ...
                    <td align="center">
                        ...
                        @else
                        <a href="{{ route('Sempro.cancelSurat', ['id' => $data->id_sempro]) }}" class="btn btn-danger btn-block btn-sm" >Batal</a>
                        @endif
                    </td>
                    {{-- <td align="center">
...
<form action="{{ route('Sempro.update', ['id' => $data->id_sempro]) }}" method="POST" enctype="multipart/form-data">
    @csrf
    <!-- Extra large modal -->
