    ...
    <div class="card">
        ...
        <div class="card-body">
          <table class="table table-bordered table-striped table-hover">
            ...
            <tbody>
                @foreach ( $data_skripsi as $key => $data )
                <tr>
                    <td>{{ $key + 1 }}</td>
                    ...
                    <td>{{ is_numeric($data->dosen_penguji1) ? $data->dospeng1()->first()->nama : $data->dosen_penguji1 }}</td>
                    <td>{{ is_numeric($data->dosen_penguji2) ? $data->dospeng2()->first()->nama : $data->dosen_penguji2 }}</td>
                    <td align="center">
...
<form action="{{ route('Skripsi.update', ['id' => $data->id_skripsi]) }}" method="POST" enctype="multipart/form-data">
    @csrf
    <!-- Extra large modal -->
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="custom-file">
                        <input name="url_jadwal" type="file" class="custom-file-input" id="exampleInputFile1">
