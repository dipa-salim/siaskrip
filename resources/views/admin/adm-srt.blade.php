          ...
          <table class="table table-bordered table-striped table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ is_numeric($data->dosen_pembimbing1) ? $data->dospem1()->first()->nama : $data->dosen_pembimbing2 }}</td>
                    <td>{{ is_numeric($data->dosen_pembimbing2) ? $data->dospem2()->first()->nama : $data->dosen_pembimbing2 }}</td>
                    {{-- <td>{{ $data->dospem2()->first()->nama }}</td> --}}
                    <td align="center">
...
<form action="{{ route('SuratTugas.update', ['id' => $data->id_surat_tugas]) }}" method="POST" enctype="multipart/form-data">
    @csrf
    <!-- Extra large modal -->
