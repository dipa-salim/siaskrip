		...
		<div class="container-login100">
			<div class="wrap-login100">
				<div class="login100-pic js-tilt" data-tilt>
					<img src="{{ url('adminlte/img/loginlogo.jpg') }}" alt="IMG">
				</div>
    <form class="login100-form validate-form" action="{{ route('Auth.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        ...
        <div class="wrap-input100 validate-input" data-validate = "Username is required">
            <input class="input100" type="nama" name="nama" placeholder="Username">
            <span class="focus-input100"></span>
            <span class="symbol-input100">
