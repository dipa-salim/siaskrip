    ...
    <div class="card">
        ...
        <div class="card-body">
          <table class="table table-bordered table-striped table-hover">
            ...
            <tbody>
                @foreach ( $data_dosen_sempro as $key => $data )
                <tr>
                    <td>{{ $key + 1 }}</td>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <table class="col-lg">
                        ...
                        <tr>
                        <th><iframe src="{{ asset($data->url_lembar_sempro) }}" title="description" style="height: 350px;width:350px;"></iframe></th>
                        <th><iframe src="{{ asset($data->url_logbook_sempro) }}" title="description" style="height: 350px;width:350px;"></iframe></th>
                        </tr>
                        <tr align="center">
                            <td>Materi Proposal</td>
                        </tr>
                        <tr>
                        <th><iframe src="{{ asset($data->url_proposal) }}" title="description" style="height: 350px;width:350px;"></iframe></th>
                        </tr>
                    </table>
                </div>
            </div>
...
<form action="{{ route('MhsBimbingan.updateDosenSempro', ['id' => $data->id_mhs_bimbingan]) }}" method="POST" enctype="multipart/form-data">
    @csrf
    <!-- Extra large modal -->
    <div class="modal fade bd-example-modal-md" id="setujui-{{ $key }}" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Kirim Persetujuan Sempro</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                          <div class="custom-file">
                            <input name="url_lembar_sempro_ttd" value="{{ old('url_lembar_sempro_ttd') }}" type="file" class="custom-file-input" id="exampleInputFile1">
                      ...
                      <div class="form-group">
                        ...
                        <div class="input-group">
                          <div class="custom-file">
                            <input name="url_logbook_sempro_ttd" value="{{ old('url_logbook_sempro_ttd') }}" type="file" class="custom-file-input" id="exampleInputFile1">
                            <label class="custom-file-label" for="exampleInputFile">Choose file</label>
                          </div>
                        </div>
                      </div>
