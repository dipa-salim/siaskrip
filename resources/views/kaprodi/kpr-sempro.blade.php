    ...
    <div class="card">
        ...
        <div class="card-body">
          <table class="table table-bordered table-striped table-hover">
            ...
            <tbody>
                @foreach ($data_sempro_kaprodi as $key => $data )
                <tr>
                    <td>{{ $key+1 }}</td>
                    ...
                    <td align="center">
                        ...
                        @else
                        <a href="{{ route('Sempro.cancelKaprodi', ['id' => $data->id_sempro]) }}" class="btn btn-danger btn-block btn-sm" >Batal</a>
                        @endif
                    </td>
                </tr>
                @endforeach
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <table class="col-lg">
                        <tr align="center">
                            <td>Lembar Persetujuan Dosen</td>
                            <td>Materi Proposal</td>
                        </tr>
                        <tr>
                        <th><iframe src="{{ asset($data->url_lembar_dosen) }}" title="description" style="height: 350px;width:350px;"></iframe></th>
...
<form action="{{ route('Sempro.updateKaprodi', ['id' => $data->id_sempro]) }}" method="POST" enctype="multipart/form-data">
    @csrf
    <!-- Extra large modal -->
    <div class="modal fade bd-example-modal-md" id="setujui-{{ $key }}" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Kirim Jadwal Sempro</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                 ...
                 <div class="form-group">
                      <label for="dosen_penguji1">Dosen Penguji 1</label>
                        ...
                        <select class="form-control" id="dosen_penguji1" name="dosen_penguji1">
                          ...
                          <input id="dosen_penguji1_text" type="text" placeholder="Nama Dosen Pembimbing" class="form-control" name="dosen_pembimbing1_text">
                      </div>
                      <div class="form-group">
                        ...
                        <select class="form-control" id="dosen_penguji2" name="dosen_penguji2">
                          ...
                          <input id="dosen_penguji2_text" type="text" placeholder="Nama Dosen Pembimbing" class="form-control" name="dosen_pembimbing1_text">
                      </div>
                </div>
