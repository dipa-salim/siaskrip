...
@endpush
@section('page')
  <li class="breadcrumb-item active">Pengajuan Surat Tugas</li>
@endsection
@section('content')
<div class="col-md-12">
    <div class="card">
        ...
        <div class="card-body">
          <table class="table table-bordered table-striped table-hover">
            ...
            <tbody>
                @foreach ( $data_surat_kaprodi as $key => $data)
                <tr>
                    <td>{{ $key+1 }}</td>
                    ...
                    <td align="center">
                        ...
                        @else
                        <a href="{{ route('SuratTugas.cancelKaprodi', ['id' => $data->id_surat_tugas]) }}" class="btn btn-danger btn-block btn-sm" >Batal</a>
                        @endif
                    </td>
                </tr>
                @endforeach
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <table class="col-lg">
                        <tr align="center">
                            <td>Bab 1</td>
                            <td>Surat Persetujuan Dosen Pembimbing</td>
                        </tr>
                        <tr>
...
<form action="{{ route('SuratTugas.updateKaprodi', ['id' => $data->id_surat_tugas]) }}" method="POST" enctype="multipart/form-data">
    @csrf
    <!-- Extra large modal -->
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                      <div class="form-group">
                        ...
                        <input type="hidden" name="mahasiswa" value="{{ $data->id_mahasiswa }}">
                        ...
                        <select class="form-control" id="dosen_pembimbing1" name="dosen_pembimbing1">
                            ...
                            {{-- <option value="Irma Permata Sari, S.Pd., M.Eng">Irma Permata Sari, S.Pd., M.Eng</option> --}}
                        </select>
                        {{-- Element yang ditambahkan --}}
                      ...
                      <div class="form-group" id="noId">
                        ...
                        <select id="dosen_pembimbing2" class="form-control" id="dosen_pembimbing2" name="dosen_pembimbing2">
                            <option value="">-- Select --</option>
                            @foreach ($dosen as $data)
                            <option value="{{ $data->id_dosen }}">{{ $data->nama }}</option>
                            @endforeach
                            <option value="0">Lainnya</option>
                            {{-- <option value="Dr. Widodo, M.Kom.">Dr. Widodo, M.Kom.</option>
                            <option value="Irma Permata Sari, S.Pd., M.Eng">Irma Permata Sari, S.Pd., M.Eng</option> --}}
                        </select>
                        {{-- Element yang ditambahkan --}}
