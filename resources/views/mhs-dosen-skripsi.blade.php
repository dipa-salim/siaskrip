...
<form action="{{ route('MhsBimbingan.updateSkripsi', ['id' => $data->id_mhs_bimbingan]) }}" method="POST" enctype="multipart/form-data">
    @csrf
    <!-- Extra large modal -->
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Kirim Persetujuan Sidang Skripsi</h4>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                          <div class="custom-file">
                            <input name="url_lembar_skripsi" value="{{ old('url_lembar_skripsi') }}" type="file" class="custom-file-input" id="exampleInputFile1">
                            <label class="custom-file-label" for="exampleInputFile">Choose file</label>
                          </div>
                        </div>
                      </div>
                      <div class="form-group">
                        <label for="exampleInputFile1">Lembar Kegiatan Bimbingan</label>
                        <div class="input-group">
                          <div class="custom-file">
                            <input name="url_logbook_skripsi" value="{{ old('url_logbook_skripsi') }}" type="file" class="custom-file-input" id="exampleInputFile1">
                            <label class="custom-file-label" for="exampleInputFile">Choose file</label>
                          </div>
                        </div>
                      </div>
